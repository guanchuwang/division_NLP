...
def main():
    ...
    if adapter_args.apply_sampling:
        from seq2seq.approxlinear import ApproxLinearConfig
        approx_config = ApproxLinearConfig()
        approx_config.only_bw = adapter_args.only_bw
        approx_config.sampling_ratio = adapter_args.sampling_ratio
        approx_config.deter_ratio = adapter_args.deter_ratio
        approx_config.deter_adaptive = adapter_args.deter_adaptive
        approx_config.sample_replacement = adapter_args.sample_replacement
        approx_config.mix_replacement = adapter_args.mix_replacement
        approx_config.tasks = [data_args.task_name]
        approx_config.k_sampling    = adapter_args.k_sampling
        approx_config.q_sampling    = adapter_args.q_sampling
        approx_config.v_sampling    = adapter_args.v_sampling
        approx_config.o_sampling    = adapter_args.o_sampling
        approx_config.wi_0_sampling = adapter_args.wi_0_sampling
        approx_config.wi_1_sampling = adapter_args.wi_1_sampling
        approx_config.wo_sampling   = adapter_args.wo_sampling
        approx_config.score_sampling   = adapter_args.score_sampling
        approx_config.attout_sampling   = adapter_args.attout_sampling
        approx_config.softmax_prune_ratio   = adapter_args.softmax_prune_ratio
        ...
        approx_config.lfc_block   = adapter_args.lfc_block
        approx_config.hfc_bit   = adapter_args.hfc_bit
