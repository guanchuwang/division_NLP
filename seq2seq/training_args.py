...
class AdapterTrainingArguments:
    ...
    apply_sampling: bool = field(default=False, metadata={"help": "Whether apply top-k sampling."})
    sampling_ratio: float = field(default=1.0, metadata={"help": "sampling ratio for the top-k sampling)."})
    deter_ratio: float = field(default=0.5, metadata={"help": "ratio of deterministic selection for top-k sampling."})
    deter_adaptive: bool = field(default=True, metadata={"help": ""})
    sample_replacement: bool = field(default=True, metadata={"help": ""})
    mix_replacement: bool = field(default=False, metadata={"help": ""})
    only_bw: bool = field(default=True, metadata={"help": "apply top-k sampling only in backward or not."})
    k_sampling: bool = field(default=False, metadata={"help":    "apply top-k sampling for k weight."})
    q_sampling: bool = field(default=False, metadata={"help":    "apply top-k sampling for q weight."})
    v_sampling: bool = field(default=False, metadata={"help":    "apply top-k sampling for v weight."})
    o_sampling: bool = field(default=True, metadata={"help":    "apply top-k sampling for o weight."})
    wi_0_sampling: bool = field(default=True, metadata={"help": "apply top-k sampling for wi0 weight."})
    wi_1_sampling: bool = field(default=True, metadata={"help": "apply top-k sampling for wi1 weight."})
    wo_sampling: bool = field(default=True, metadata={"help":   "apply top-k sampling for wo weight."})
    score_sampling: bool = field(default=True, metadata={"help":   "apply top-k sampling for score matmul."})
    attout_sampling: bool = field(default=True, metadata={"help":   "apply top-k sampling for attention out matmul."})
    softmax_prune_ratio: float = field(default=1., metadata={"help": ""})
    quant_relu: bool = field(default=True, metadata={"help":   ""})
    quant_dropout: bool = field(default=True, metadata={"help":   ""})
    inplace_layernorm: bool = field(default=True, metadata={"help":   ""})
    lfc_block: int = field(default=8, metadata={"help": ""})
    hfc_bit: int = field(default=2, metadata={"help": ""})
    level: int = field(default=0, metadata={"help":   "the optimization level."})
