...
# from seq2seq.approxlinear.trainer import FT_Seq2SeqTrainer as BaseSeq2SeqTrainer
from .trainer import BaseTrainer

if version.parse(torch.__version__) >= version.parse("1.6"):
    from torch.cuda.amp import autocast

class Seq2SeqTrainer(BaseSeq2SeqTrainer, BaseTrainer):
